...
def main(args):
    # filename
    dataset_type = f'test_monte_carlo_[[-135, -120, -60, 0, 60], [35, 30, 10, 30, 10]]_rho{args.rho}' + '_' + str(
...
if __name__ == "__main__":
    ...
    load_root = os.path.join(root_path, 'results', 'vit', f'vit_2D_DOA_origin_transfer_learning_rho_1_mse+angle_sample500')
