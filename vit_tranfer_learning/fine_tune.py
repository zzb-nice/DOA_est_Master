...
def main(args):
    # train_theta_set = Create_monte_carlo_theta(all_theta=[np.array([10, 13, 16])], repeat_num=500)
    train_theta_set = Create_random_k_input_theta(args.k, args.signal_range[0],
                                                  args.signal_range[1], 200, min_delta_theta=3)
    ...
    save_path = args.root + f'_fine_tune_rho_{args.rho}_200'
...
if __name__ == "__main__":
    ...
    root = os.path.join(root_path, 'results', 'vit', f'vit_range_num')
