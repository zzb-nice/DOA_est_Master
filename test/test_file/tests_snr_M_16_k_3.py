...
def main(args):
    test_type = "random_input"  # random_input,monte_carlo[10,20,30],monte_carlo[10,13,16],[-25,5,25],...
    # filename
    ...
    for repeat_i in range(args.repeats):
        for step_1, snr in enumerate(args.snrs):
            ...
            suc_ratio, test_loss, predict_result = test(model, dataloader, loss_function, args.device,
        ...
        # save model loss and succ_ratio
...
if __name__ == "__main__":
    ...
    load_root = os.path.join(root_path, 'results', 'vit', f'vit_M_16_k_3')
