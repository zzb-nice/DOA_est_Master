...
if __name__ == "__main__":
    ...
    dataset_path = os.path.join(root_path, 'data', 'ULA_data', 'test', f'M_8_k_7_test1_rho0')
    load_root = os.path.join(root_path, 'results', 'vit', f'vit_M_8_k_7')
