...
def main(args):
    ...
    for step_1, snap in enumerate(args.snaps):
        ...
        train_dataloader = array_Dataloader(dataset, 256, load_style='torch', input_type='scm', output_type='spatial_sp')
        val_dataloader = array_Dataloader(val_dataset, 256, shuffle=False, load_style='torch',
                                          input_type='scm', output_type='spatial_sp')
...
if __name__ == "__main__":
    ...
    save_root = os.path.join(root_path, 'results', 'vit', f'vit_v_snap')
