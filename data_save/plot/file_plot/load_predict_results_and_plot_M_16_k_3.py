...
def main(args):
    ...
    load_path = os.path.join(args.root_path,
                             f'results/vit/vit_M_16_k_3/{args.file_test_id}_{test_type}/model_predict_results.npy')
    # 读取预测结果
    ...
    load_root = [
        os.path.join(args.root_path,
                     f'results/vit/vit_M_16_k_3/{args.file_test_id}_{test_type}/MUSIC_predict_results.npy'),
        os.path.join(args.root_path,
                     f'results/vit/vit_M_16_k_3/{args.file_test_id}_{test_type}/Unity-ESPRIT_predict_results.npy'),
        os.path.join(args.root_path,
                     f'results/vit/vit_M_16_k_3/{args.file_test_id}_{test_type}/$\ell_1$-SVD_predict_results.npy'),
        os.path.join(args.root_path,
                     f'results/vit/vit_M_16_k_3/{args.file_test_id}_{test_type}/SPE-CNN_predict_results.npy'),
        os.path.join(args.root_path,
                     f'article_implement/ASL/results/ASL_M_16_k_3/{args.file_test_id}_{test_type}_rho0/pred_results_and_RMSE.mat'),
        os.path.join(args.root_path,
                     f'article_implement/SubspaceNet/results/SubspaceNet_M_16_k_3_snap_10/{args.file_test_id}_{test_type}/model_predict_results.npy'),
        os.path.join(args.root_path,
                     f'article_implement/Learning_SPICE/results/R_fit_M_16_k_3/{args.file_test_id}_{test_type}/pred_results_and_RMSE.mat')
    ]
...
if __name__ == "__main__":
    ...
    dataset_path = os.path.join(root_path, 'data', 'ULA_data', 'test', f'M_16_k_3_test1_rho0')  # 注意要修改数据路径
    ...
    args.save_root = os.path.join(root_path, 'data_save', 'vit', f'{args.file_test_id}_{args.test_type}_M_16_k_3')
