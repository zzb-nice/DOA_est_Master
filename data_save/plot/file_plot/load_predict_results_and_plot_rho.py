...
def main(args):
    ...
    load_path = os.path.join(args.root_path,
                             f'results/vit/vit_M_8_k_3/{args.file_test_id}_{test_type}_rho{args.rho}/model_predict_results.npy')
    # 读取预测结果
    ...
    # contrast_model_name = ['MUSIC', 'Unity-ESPRIT', r'$\ell_1$-SVD', 'SPE-CNN', r'Learning $\ell_1$-SVD']
    load_root = [
        os.path.join(args.root_path,
                     f'results/vit/vit_M_8_k_3/{args.file_test_id}_{test_type}_rho{args.rho}/MUSIC_predict_results.npy'),
        os.path.join(args.root_path,
                     f'results/vit/vit_M_8_k_3/{args.file_test_id}_{test_type}_rho{args.rho}/Unity-ESPRIT_predict_results.npy'),
        os.path.join(args.root_path,
                     f'results/vit/vit_M_8_k_3/{args.file_test_id}_{test_type}_rho{args.rho}/$\ell_1$-SVD_predict_results.npy'),
        os.path.join(args.root_path,
                     f'results/vit/vit_M_8_k_3/{args.file_test_id}_{test_type}_rho{args.rho}/SPE-CNN_predict_results.npy'),
        os.path.join(args.root_path,
                     f'article_implement/ASL/results/ASL_M_8_k_3/{args.file_test_id}_{test_type}_rho{args.rho}/pred_results_and_RMSE.mat'),
        os.path.join(args.root_path,
                     f'article_implement/SubspaceNet/results/SubspaceNet_M_8_k_3_snap_10/{args.file_test_id}_{test_type}_rho{args.rho}/model_predict_results.npy'),
        os.path.join(args.root_path,
                     f'article_implement/Learning_SPICE/results/R_fit_M_8_k_3_origin/{args.file_test_id}_{test_type}_rho{args.rho}/pred_results_and_RMSE.mat')
    ]
...
if __name__ == "__main__":
    ...
    dataset_path = os.path.join(root_path, 'data', 'ULA_data', 'test', f'M_8_k_3_test1_rho{rho}')  # 注意要修改数据路径
    ...
    args.save_root = os.path.join(root_path, 'data_save', 'vit', f'{args.file_test_id}_{args.test_type}_rho{rho}')
