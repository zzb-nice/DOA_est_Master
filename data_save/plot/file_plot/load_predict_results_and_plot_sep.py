...
def main(args):
    ...
    load_path = os.path.join(args.root_path,
                             f'results/vit/vit_M_8_k_3_combine/equal_sep_rho1_(-60, 60)/model_predict_results.npy')
    # 读取预测结果
    ...
    # 读取各个模型的预测结果
    contrast_model_name = ['transfer learning DOA-ViT', 'MUSIC','Root-MUSIC', 'Unity-ESPRIT', r'$\ell_1$-SVD', 'SPE-CNN', 'ASL-2', 'SubspaceNet', r'Learning $\ell_1$-SVD']
    load_root = [
        os.path.join(args.root_path,
                     f'results/vit/vit_M_8_k_3_transfer_learning_rho_1_mse+angle_sample500/equal_sep_rho1_(-60, 60)/model_predict_results.npy'),
        os.path.join(args.root_path,
                     f'results/vit/vit_M_8_k_3_transfer_learning_rho_1_mse+angle_sample500/equal_sep_rho1_(-60, 60)/MUSIC_predict_results.npy'),
        os.path.join(args.root_path,
                     f'results/vit/vit_M_8_k_3_transfer_learning_rho_1_mse+angle_sample500/equal_sep_rho1_(-60, 60)/Root-Music_predict_results.npy'),
        os.path.join(args.root_path,
                     f'results/vit/vit_M_8_k_3_transfer_learning_rho_1_mse+angle_sample500/equal_sep_rho1_(-60, 60)/Unity-ESPRIT_predict_results.npy'),
        os.path.join(args.root_path,
                     f'results/vit/vit_M_8_k_3_transfer_learning_rho_1_mse+angle_sample500/equal_sep_rho1_(-60, 60)/$\ell_1$-SVD_predict_results.npy'),
        os.path.join(args.root_path,
                     f'results/vit/vit_M_8_k_3_transfer_learning_rho_1_mse+angle_sample500/equal_sep_rho1_(-60, 60)/SPE-CNN_predict_results.npy'),
        os.path.join(args.root_path,
                     f'article_implement/ASL/results/ASL_M_8_k_3/equal_sep_snr_5_rho1_(-60, 60)//pred_results_and_RMSE.mat'),
        os.path.join(args.root_path,
                     f'article_implement/SubspaceNet/results/SubspaceNet_M_8_k_3_snap_10/equal_sep_rho1_(-60, 60)//model_predict_results.npy'),
        os.path.join(args.root_path,
                     f'article_implement/Learning_SPICE/results/R_fit_M_8_k_3_origin/equal_sep_rho1_(-60, 60)/pred_results_and_RMSE.mat')
    ]
...
if __name__ == "__main__":
    ...
    args.save_root = os.path.join(root_path, 'data_save', 'vit', f'{args.file_test_id}_{args.test_type}11')
