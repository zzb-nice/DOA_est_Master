...
load_root = '/home/xd/DOA_code/open_source_code/article_implement/Learning_SPICE/results/R_fit_M_8_k_3_origin/equal_sep_snr0_rho1_(-60, 60)/';
file_name = ['R_ext_' num2str(snap) '_snr_' num2str(snr) '_sep_' '[[' num2str(seps(1)) ', ' num2str(seps(1)) ']]' '.mat'];
...
for ii=1:length(threshold_vec)
    ...
    % load data
    file_name = ['R_ext_' num2str(snap) '_snr_' num2str(snr) '_sep_' '[[' num2str(seps(ii)) ', ' num2str(seps(ii)) ']]' '.mat'];
