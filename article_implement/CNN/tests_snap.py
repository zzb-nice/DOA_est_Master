...
def main(args):
    ...
    # filename
    dataset_type = f'file_test2_{test_type}'  # save path
    ...
    for repeat_i in range(args.repeats):
        for step_1, snap in enumerate(args.snaps):
            ...
            dataloader = file_array_Dataloader(load_file, 256, False, load_style='torch', input_type='enhance_scm',
                                               output_type='doa')
...
if __name__ == "__main__":
    ...
    load_root = os.path.join(root_path, 'results', 'CNN_load_path', f'std_CNN_snr_-10_v_snap')
