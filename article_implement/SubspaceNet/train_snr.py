...
from signal_datasets import ULA_dataset, array_Dataloader
...
def main(args):
    ...
    for step_1, snr in enumerate(args.snrs):
        ...
        train_dataloader = array_Dataloader(dataset, 256, load_style='torch', input_type='tau_cat_scm',
                                            output_type='doa')
        val_dataloader = array_Dataloader(val_dataset, 256, shuffle=False, load_style='torch',
                                          input_type='tau_cat_scm', output_type='doa')
