...
if __name__ == "__main__":
    ...
    dataset_path = os.path.join(root_path, 'data', 'ULA_data', 'test', f'M_8_k_3_snap_10_snr_0_rho{rho}_min_sep')
    load_root = os.path.join(root_path, 'article_implement', 'SubspaceNet', 'results', f'SubspaceNet_M_8_k_3_snap_10')
